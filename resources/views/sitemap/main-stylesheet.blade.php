...
<xsl:stylesheet version="2.0" xmlns:html="http://www.w3.org/TR/REC-html40"
    ...
    <xsl:template match="/">
        ...
        <body>
            <div id="content">
                <h1>XML Sitemap</h1>
                <p class="expl"> Generated by <string name="link_str">
                        <a
                            href="mailto:shubhambth0000@gmail.com?subject=Hi!, I need help regarding sitemap files and css that you created for {{ Route('frontend.home') }}.">Shubham
                            Raj</a>
                    </string>, this is an XML Sitemap, meant for consumption by
                    search engines.<br /> You can find more information about XML sitemaps on <a
                        href="https://sitemaps.org" target="_blank" rel="noopener">sitemaps.org</a>
                    . </p>
                    ...
                    <table id="sitemap" cellpadding="3">
                        <thead>
                            <tr>
                                ...
                                <th title="Last Modification Time" width="18%">Last Mod.</th>
                            </tr>
                        </thead>
                        <tbody>
