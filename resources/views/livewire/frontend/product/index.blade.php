<div class="row">
    ...
    <div class="col-lg-12">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-4 p-0">
                    <input type="search" name="city" value="{{ Request::get('city') }}"
                        class="form-control search-slt" placeholder="Enter local address - City - Venue Name or Other">
                </div>
                <div class="col-md-3 p-0">
        ...
        {{-- <form id="search-form" action="searching" method="post">
                @csrf
                <div class="row justify-content-center">
                    <div class="col-md-3 p-0">
                        <select class="form-control search-slt" id="exampleFormControlSelect1">
                    ...
                    <div class="col-md-3 p-0">
                        <button type="search" class="btn btn-primary wrn-btn">Search</button>
                    </div>
                </div>
            </form> --}}
    </div>
    ...
    <div class="col-lg-12">
        <div class="h6 mt-4 mb-4">
            ...
            <a class="text-decoration-none " href="{{ url('/venue') }}">
                <span class="text-danger">Venue / </span> <span class="text-dark">{{ $category->name }}</span>
            </a>
        </div>
    </div>
    <div class="col-lg-4">
        <div class="card">
            ...
            <div class="card-body">
                <div class="my-2">
                    <a class="text-dark"
                        href="{{ url('/search?_token=uIBhs8pC1a8BvyL9CTWPc1PfHFoMIr48kr2HukL2&search=All') }}">All </a>
                </div>
                <div class="my-2">
                    <a class="text-dark"
                ...
                <div class="mt-2">
                    <label for="price">
                        <input type="radio" name="price" id="price" wire:model="priceInput"
                            value="high-to-low" /> High to
                        low
                    </label>
                    <p>
                        <label for="price">
                            <input type="radio" name="price" id="price" wire:model="priceInput"
                                value="low-to-high" /> Low to
                            high
                        </label>
                    </p>
                </div>
    ...
    <div class="col-lg-8">
        <div class="row">
                                    ...
                                    <a href="{{ url('/venue/' . $productItem->category->slug . '/' . $productItem->slug) }}"
                                        ...
                                        @if ($productItem->productImages->count() > 0)
                                            <img src="{{ asset($productItem->productImages[0]->image) }}"
                                                ...
                                                class="mx-auto d-block img-fluid p-2 w-100" style="height: 150px;">
                                        @else
                                            <img src="{{ asset('assets/images/no-images.png') }}"
                                                alt=" {{ $productItem->name }}" class="mx-auto d-block img-fluid p-2">
                                        @endif
                                    </a>
                                </div>
                                <div class="col-md-4">
                                        ...
                                        <p class="text-center">
                                            <button type="button" id="dam_return"
                                                ...
                                                <div style="display: none">
                                                    {{ $productItem->name }}-{{ $productItem->full_address }}" </div>
                                                Request to Book
                                            </button>
                                        </p>
                                    </div>
            ...
            @empty
                <h4 class="mt-4">No venue available for {{ $category->name }}</h4>
            @endforelse
                                    ...
                                    <form action="{{ route('contact-form.store') }}" method="post"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group" required>
                                                    <select name="occasion_type" id="occasion_type"
                                                        ...
                                                        <option value="Engagement Ceremony"> Engagement Ceremony
                                                        </option>
                                                        <option value="Wedding Anniversary"> Wedding Anniversary
                                                        </option>
                                                        <option value="Birthday Party"> Birthday Party </option>
                                                        <option value="Birthday Party for Kids"> Birthday Party for
                                                            Kids</option>
                                                        <option value="Corporate party">Corporate party</option>
                                                        <option value="Corporate Training"> Corporate Training
                                                        </option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <button type="submit"
                                                        class="btn btn-primary btn-md col-md-12">Check
                                                        availability</button>
                                                </div>
                                            </div>
                                        </div> {{-- Row --}}
