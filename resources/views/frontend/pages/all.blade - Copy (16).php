    ...
    <div class="container">
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="my-2">
                        <a class="text-dark" href="{{url('/search?_token=uIBhs8pC1a8BvyL9CTWPc1PfHFoMIr48kr2HukL2&search=All')}}">All </a>
                    </div>
                    <div class="my-2">
                        <a class="text-dark" href="{{ url('/search?_token=YFjP4WRWg8VO2q9onx6CmKWRBaU5i7bReNKXE1uH&search=&search=Hotels') }}">Hotels </a>
                    </div>
                    <div class="my-2">
                        <a class="text-dark" href="{{ url('/search?_token=YFjP4WRWg8VO2q9onx6CmKWRBaU5i7bReNKXE1uH&search=Resorts') }}">Resorts </a>
                    </div>
                    <div class="my-2">
                        <a class="text-dark" href="{{ url('/search?_token=YFjP4WRWg8VO2q9onx6CmKWRBaU5i7bReNKXE1uH&search=Restaurants') }}">Restaurants </a>
                    </div>
                    <div class="my-2">
                        <a class="text-dark" href="{{ url('/search?_token=YFjP4WRWg8VO2q9onx6CmKWRBaU5i7bReNKXE1uH&search=Bars+and+nightclubs') }}">Bars and nightclubs </a>
                    </div>
                    <div class="my-2">
                        <a class="text-dark" href="{{ url('/search?_token=YFjP4WRWg8VO2q9onx6CmKWRBaU5i7bReNKXE1uH&search=Conference+centers') }}">Conference centers </a>
                    </div>
                    <div class="my-2">
                        <a class="text-dark" href="{{ url('/search?_token=YFjP4WRWg8VO2q9onx6CmKWRBaU5i7bReNKXE1uH&search=Theaters') }}">Theaters </a>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="mt-2">
                        <label for="high-to-low">
                            <input type="radio" name="price" id="price" wire:model="priceInput" value="high-to-low" /> High to low
                        </label>
                        <p>
                            <label for="low-to-high">
                                <input type="radio" name="price" id="price" wire:model="priceInput" value="low-to-high" /> Low to high
                            </label>
                        </p>
                    </div>
                </div>
                ...
                <div class=" mb-5">
                    <div class="shadow">
                        <div class="product-card h-100">
                            <div class="row">
                                <div class="col-md-4">
                                    <a href="{{ url('/venue/'.$productItem->category->slug.'/'.$productItem->slug) }}" class="text-black text-decoration-none" target="_blank">
                                        @if ($productItem->productImages->count()>0)
                                        <img src="{{ asset($productItem->productImages[0]->image) }}" alt=" {{ $productItem->name }}" class="mx-auto d-block img-fluid p-2">
                                        @else
                                        <img src="{{ asset('assets/images/no-images.png') }}" alt=" {{ $productItem->name }}" class="mx-auto d-block img-fluid p-2">
                                        @endif
                                    </a>
                                </div>
                                <div class="col-md-4">
                                    <a href="{{ url('/venue/'.$productItem->category->slug.'/'.$productItem->slug) }}" class="text-dark text-decoration-none" target="_blank">
                                    ...
                                    <div class="bg-light h-100 ">
                                        <div class="col-lg-12">
                                            <div class="pt-2 pb-2">
                                                ...
                                                {{ $productItem->veg_sell_price_one}} - {{ $productItem->vegprice_one}}
                                                <br>
                                                <span class="fa-stack other_food">
                                                    <i class="fa fa-square-o fa-stack-2x red-symbol"></i>
                                                    <i class="fa fa-circle fa-stack-1x red-sym"></i>
                                                </span>
                                                <font class="other_price">NonVeg : <i class="fa fa-inr" aria-hidden="true"></i></font>
                                                {{ $productItem->non_sell_price_one}} - {{ $productItem->nonprice_one}}
                                            </div>
                                        ...
                                        <p class="text-center">
                                            <button type="button" id="dam_return" value="{{ $productItem->name }}-{{ $productItem->full_address }}" class="btn btn-primary" data-toggle="modal" data-target="#inqueryModal">
                                                <div style="display: none">{{ $productItem->name }}-{{ $productItem->full_address }}" </div> Request to Book
                                            </button>
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="span4 collapse-group">
                                <form action="{{ route('contact-form.store') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <input type="text" name="venue_address" id="venue_address" class="form-control" placeholder="Enter your address" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
