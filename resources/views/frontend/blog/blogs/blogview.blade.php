...
@section('title')
    {{ $blogsdata->meta_title }} - Venue wala
@endsection
@section('keywords')
    {{ $blogsdata->meta_keyword }} - Venue wala
@endsection
@section('description')
    {{ $blogsdata->meta_description }} - Venue wala
@endsection
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="mt-3 mb-4">
                        ...
                        <a
                            href="{{ url('/blog/' . $blogsdata->blogcategory->slug) }}">{{ $blogsdata->blogcategory->name }}/</a>
                    ...
                    @if (!empty($blogsdata->description))
                        <div class="card box-shadow border-none">
                            ...
                            <div class="card-body border-none">
                                <div class="mb-4">
                                    <img src="{{ asset('uploads/blogs/' . $blogsdata->image) }}"
                                        class="mx-auto d-block img-fluid" alt="{{ $blogsdata->name }}">
                                </div>
                                @php
                                ...
                                <div>
                                    <form action="{{ route('contact-form.store') }}" method="post"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <input type="text" name="venue_address" id=""
                                                        class="form-control" placeholder="Venue address">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group">
