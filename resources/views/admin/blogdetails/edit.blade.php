                                ...
                                <div class="row mt-2">
                                    <div class="col-lg-6">
                                        <div class="form-group ">
                                            ...
                                            <select name="blogcategory_id" id="" class="form-control">
                                                <option value="{{$blog->id}}" selected>{{$blog->blogcategory->name}}</option>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group ">
                                            ...
                                            <input type="text" name="name" value="{{$blog->name}}" id="" class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form-group ">
                                            <label for="">Blog slug</label>
                                            <input type="text" name="slug" value="{{$blog->slug}}" id="" class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form-group ">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group ">
                                            ...
                                            <img src="{{ asset('uploads/blogs/'.$blog->image) }}" width="100" alt="images">
                                        </div>
                                    </div>
                                </div>
                                {{-- end tab --}}
                                ...
                                {{-- tab --}}
                                  <div class="row mt-2">
                                    <div class="col-lg-12">
                                        ...
                                        <textarea name="meta_title" id="" cols="20" rows="10" class="form-control" >{{$blog->meta_title}}</textarea>
                                    </div>
                                  </div>
                                  <div class="row mt-2">
                                    <div class="col-lg-12">
                                        <label for="">Meta Keyword</label>
                                        <textarea name="meta_keyword" id="" cols="20" rows="10" class="form-control" >{{$blog->meta_keyword}}</textarea>
                                    </div>
                                  </div>
                                  <div class="row mt-2">
                                    <div class="col-lg-12">
                                        <label for="">Meta Description</label>
                                        <textarea name="meta_description" id="" cols="20" rows="10" class="form-control">{{$blog->meta_description}}</textarea>
                                    </div>
                                  </div>
                                {{-- end tab --}}
                            </div>
                                ...
                                {{-- tab --}}
                                 <div class="row mt-2">
                                    <div class="col-lg-12">
                                        ...
                                        <input type="checkbox" name="status" id="" value="{{$blog->status == '1' ? 'checked':''}}">
                                    </div>
                                 </div>
                                {{-- end tab --}}
                            </div>
