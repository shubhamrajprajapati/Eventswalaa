       ...
       <div class="sidebar-menu">
          <ul id="accordion-menu">
             ...
             <li class="dropdown">
                ...
                <ul class="submenu">
                   <li><a href="{{ url('vendors/products/create')}}">Add Venue</a></li>
                   <li><a href="{{ url('vendors/products')}}">View Venue</a></li>
                </ul>
             </li>
             {{-- <li class="dropdown">
               <a href="javascript:;" class="dropdown-toggle">
               ...
               <ul class="submenu">
                  <li><a href="{{ url('vendors/orders')}}">View Orders</a></li>
               </ul>
            </li> --}}
             <li class="{{ Request::is('vendors/ratings') ? 'active' : '' }}">
               <a href="{{ url('vendors/ratings')}}" class="dropdown-toggle no-arrow">
